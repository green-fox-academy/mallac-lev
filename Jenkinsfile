pipeline {
  ...
  stages {
    ...
    stage('Deploy to EB') {
      ...
      steps{
        withCredentials([[$class: 'AmazonWebServicesCredentialsBinding', accessKeyVariable: 'AWS_ACCESS_KEY_ID', credentialsId: '42bf03de-054f-439d-ae4b-c9deb7303a7a', secretKeyVariable: 'AWS_SECRET_ACCESS_KEY']]) {
